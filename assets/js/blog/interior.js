...
const menu_links = document.querySelectorAll('a.bar-item');

const makeActive = (link) => menu_links[link].classList.add('white');
const removeActive = (link) => menu_links[link].classList.remove('white');
